...
public class Order {
	...
	@ApiModelProperty(notes = "存储商品规格信息,Json字符串")//example = "{'productName':'商品名称','versionName':'版本名称','customName':'规格名称','optionName':'流量名称'}"
	...
	@ApiModelProperty(notes = "支付方式 0-余额 1-微信 2-支付宝 3-代金券",example = "1")
