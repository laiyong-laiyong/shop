...
public interface RoleService {
	...
	void addResPermOnRole1(@PathVariable(value = "roleCode") String roleCode,
	...
	@PutMapping(value = "/v1.0/role/resource/{role_code}/list")
	void appendResPermOnRole(@PathVariable(value = "role_code") String role_code,
			List<ResourcePermissions> resourcePermissions,
			@RequestHeader(value = "sobeyhive-http-token") String value,
			@RequestHeader(value = "sobeyhive-http-site") String site);
	
	
	@DeleteMapping(value = "/v1.0/role/resource/{role_code}/list")
	void deleteResPermOnRole(@PathVariable(value = "role_code") String role_code,
			List<String> resource_codes,
			@RequestHeader(value = "sobeyhive-http-token") String value,
			@RequestHeader(value = "sobeyhive-http-site") String site);
