...
public class MediaService extends ServiceImpl<MediaMapper, Media> {
	...
	public String insert(List<String> list, String workOrderId, String mediaId, String type) {
	 ...
	 * @param mediaId
	 */
	public String save(MultipartFile[] files, String destPath, String productId, String mediaId,
			String type) {
