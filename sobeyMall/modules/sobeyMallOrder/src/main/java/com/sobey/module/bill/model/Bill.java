...
/**
 * @author WCY
 * @createTime 2020/5/18 11:10
 * 账单
 */
@TableName("mall_bill")
@ApiModel
public class Bill extends SuperModel<Bill> {
    ...
    @ApiModelProperty(notes = "主要用于显示用户消费top")
    private List<PersonalBill> personalBills;

    @TableField(exist = false)
    @ApiModelProperty(notes = "主要用于显示产品销售top")
    ...
    public List<PersonalBill> getPersonalBills() {
        return personalBills;
    }

    public void setPersonalBills(List<PersonalBill> personalBills) {
        this.personalBills = personalBills;
    }
