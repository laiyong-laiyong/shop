package com.sobey.util.common.string;
...
/**
 * 字符串工具类 Created by Rukiy on 2017-11-21
 */
public class StrKit {
	private StrKit() {
		// 静态类不可实例化
	...
	public static String unEscapeHtml(String str) {
		...
		return str.replaceAll(HTML_LT, "<").replaceAll(HTML_GT, ">").replaceAll(HTML_QUOTE, "\"").replaceAll(HTML_AMP, "&");
	}
